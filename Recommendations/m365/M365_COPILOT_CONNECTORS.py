    ...
    if status == "Success" and m365_insights and m365_insights.get('available'):
        ...
        if total_active_users >= 30 and sharepoint_total_files >= 200:
            rec = new_recommendation(
                ...
                recommendation=f"Develop custom Copilot connectors for your CRM, ERP, ticketing, and proprietary systems. With {total_active_users:,} users across {sharepoint_total_files:,} files, you have enterprise data sprawl - Connectors unify access via AI. Build plugins for: Salesforce queries, ServiceNow ticket creation, SAP data lookups, custom API calls. Enable Copilot to become single interface for ALL your systems, not just M365.",
