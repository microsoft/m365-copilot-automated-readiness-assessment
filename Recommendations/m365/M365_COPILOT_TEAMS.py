    ...
    if status == "Success" and m365_insights and m365_insights.get('available'):
        ...
        if teams_total_meetings >= 150:
            rec = new_recommendation(
                ...
                recommendation=f"Deploy Teams Copilot training focused on meeting efficiency: Enable automatic meeting summaries for your {teams_total_meetings:,} meetings, teach users to ask 'What were the action items?' and 'Summarize decisions made', use chat Copilot for real-time Q&A during meetings. Measure time saved from not attending every meeting - users can review AI summaries instead. With {teams_avg_meetings_per_user:.1f} avg meetings per user, Copilot is critical productivity tool.",
        ...
        # Moderate meetings - pilot Teams AI
            ...
            rec = new_recommendation(
                ...
                recommendation=f"Pilot Teams Copilot with meeting-heavy roles: executives (leadership meetings), project managers (daily standups), customer-facing teams (client calls). Test meeting summaries, action item extraction, and catch-up features across your {teams_total_meetings:,} meetings. Track meeting time reduction and satisfaction before broader rollout.",
